...
class Hook extends CommonObject
{
     ...
     */
    public $table_element = 'zapierfordolibarr_hook';
     ...
     */
    public $picto = 'hook@zapierfordolibarr';
    ...
    public $fields = array(
        ...
        //'ref' =>array(
        //    'type'=>'varchar(128)',
        //    'label'=>'Ref', 'enabled'=>1, 'visible'=>1, 'noteditable'=>0, 'notnull'=> 1, 'default'=>'(PROV)', 'showoncombobox'=>1, 'index'=>1, 'position'=>10, 'searchall'=>1, 'comment'=>'Reference of object'),
        'entity' => array(
            'type' => 'integer',
            'label' => 'Entity',
            'enabled' => 1,
        ...
        //     'label'=>'Label',
        //     'enabled'=>1,
        //     'visible'=>1,  'position'=>30, 'searchall'=>1, 'css'=>'minwidth200', 'help'=>'Help text', 'showoncombobox'=>1,
        // ),
        'url' => array(
            'type' => 'varchar(255)',
            'label' => 'Url',
    ...
    public function getNomUrl($withpicto = 0, $option = '', $notooltip = 0, $morecss = '', $save_lastsearch_value = -1)
    {
        ...
        $url = dol_buildpath('/zapierfordolibarr/hook_card.php', 1).'?id='.$this->id;
