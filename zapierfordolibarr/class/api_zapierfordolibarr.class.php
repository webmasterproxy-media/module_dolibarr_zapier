...
dol_include_once('/zapierfordolibarr/class/hook.class.php');



/**
 * \file    htdocs/modulebuilder/template/class/api_zapierfordolibarr.class.php
 * \ingroup zapierfordolibarr
 * \brief   File for API management of hook.
 */

/**
 * API class for zapierfordolibarr hook
 *
 * @access protected
 * @class  DolibarrApiAccess {@requires user,external}
 */
class ZapierfordolibarrApi extends DolibarrApi
{
    /**
    ...
    {
        if(! DolibarrApiAccess::$user->rights->zapierfordolibarr->read) {
    ...
    public function post($request_data = null)
    {
        ...
        // $debug .= '<pre>'.print_r(DolibarrApiAccess::$user->rights->zapierfordolibarr, true).'</pre>';
        // mail('frederic.france@free.fr', 'test hook', $debug);
        if (! DolibarrApiAccess::$user->rights->zapierfordolibarr->write) {
            throw new RestException(401);
        }
    ...
    {
        if (! DolibarrApiAccess::$user->rights->zapierfordolibarr->delete) {
            throw new RestException(401);
        }
        $result = $this->hook->fetch($id);
        if (! $result) {
