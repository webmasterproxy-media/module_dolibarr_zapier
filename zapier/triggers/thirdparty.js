const subscribeHook = (z, bundle) => {
    ...
    const url = bundle.authData.url  + '/api/index.php/zapierfordolibarrapi/hook';
...
const unsubscribeHook = (z, bundle) => {
    ...
    // you need to complete. You can also register middleware to control this.
    const options = {
        url: bundle.authData.url + '/api/index.php/zapierfordolibarrapi/hook/' + bundle.subscribeData.id,
        method: 'DELETE',
    };
...
//     // For the test poll, you should get some real data, to aid the setup process.
//     const options = {
//         url: bundle.authData.url + '/api/index.php/zapierfordolibarrapi/getmoduleschoices',
//     };
...
//     const module = bundle.inputData.module;
//     const options = {
//         url: `https://actionenergie.netlogic-dev.fr/api/index.php/zapierfordolibarrapi/getactionschoices/thirparty`,
//     };
